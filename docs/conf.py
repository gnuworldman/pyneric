...
# -*- coding: utf-8 -*-
#
# pyneric documentation build configuration file, created by
# sphinx-quickstart.
#
...
exec(open(os.path.join(_PROJECT_PATH, 'src', 'pyneric', '_version.py'))
     .read())
...
latex_documents = [
  ('index', 'pyneric.tex', 'pyneric Documentation',
...
man_pages = [
    ('index', 'pyneric', 'pyneric Documentation',
     ['Craig Hurd-Rindy'], 1)
]
...
texinfo_documents = [
  ('index', 'pyneric', 'pyneric Documentation',
   'Craig Hurd-Rindy', 'pyneric', 'generic Python utilities',
   'Miscellaneous'),
]
